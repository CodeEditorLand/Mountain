...
use super::AirClient::{
    AirClient, AirMetrics, AirStatus, DownloadStream, DownloadStreamChunk, ExtendedFileInfo,
    FileInfo, FileResult, IndexInfo, ResourceUsage, UpdateInfo,
};
use super::DEFAULT_AIR_SERVER_ADDRESS;
...
///
/// // Check for updates
/// if let Some(update) = provider.check_for_updates("1.0.0".to_string(), "stable".to_string()).await? {
...
impl AirServiceProvider {
    ...
    pub async fn new(address: String) -> Result<Self, CommonError> {
        info!(
            "[AirServiceProvider] Creating AirServiceProvider at: {}",
            address
        );
    ...
    pub async fn new_default() -> Result<Self, CommonError> {
        Self::new(DEFAULT_AIR_SERVER_ADDRESS.to_string()).await
    }
    ...
    /// # async fn main() -> Result<(), CommonError> {
    /// # let provider = AirServiceProvider::new_default().await?;
    /// let token = provider.authenticate("user@example.com".to_string(), "password".to_string(), "github".to_string()).await?;
    ...
    pub async fn check_for_updates(
        ...
        let request_id = generate_request_id();
        trace!(
            "[AirServiceProvider] check_for_updates (request_id: {})",
            request_id
        );
    ...
    pub async fn download_update(
        ...
        let request_id = generate_request_id();
        trace!(
            "[AirServiceProvider] download_update (request_id: {})",
            request_id
        );
    ...
    pub async fn apply_update(
        ...
        let request_id = generate_request_id();
        trace!(
            "[AirServiceProvider] apply_update (request_id: {})",
            request_id
        );
    ...
    pub async fn download_file(
        ...
        let request_id = generate_request_id();
        trace!(
            "[AirServiceProvider] download_file (request_id: {})",
            request_id
        );
    ...
    /// # async fn main() -> Result<(), CommonError> {
    /// # let provider = AirServiceProvider::new_default().await?;
    /// let mut stream = provider.download_stream(
    ...
    /// # async fn main() -> Result<(), CommonError> {
    /// # let provider = AirServiceProvider::new_default().await?;
    /// let results = provider.search_files(
    ///     "fn main".to_string(),
    ///     "/path/to/project".to_string(),
    ///     50
    /// ).await?;
    ...
    pub async fn search_files(
        ...
        self.client
            .search_files(request_id, query, path, max_results)
            .await
    }
    ...
    pub async fn get_status(&self) -> Result<AirStatus, CommonError> {
        let request_id = generate_request_id();
        trace!(
            "[AirServiceProvider] get_status (request_id: {})",
            request_id
        );
    ...
    pub async fn get_metrics(
        ...
        let request_id = generate_request_id();
        trace!(
            "[AirServiceProvider] get_metrics (request_id: {})",
            request_id
        );
    ...
    pub async fn get_resource_usage(&self) -> Result<ResourceUsage, CommonError> {
        let request_id = generate_request_id();
        trace!(
            "[AirServiceProvider] get_resource_usage (request_id: {})",
            request_id
        );
    ...
    pub async fn set_resource_limits(
        ...
        let request_id = generate_request_id();
        trace!(
            "[AirServiceProvider] set_resource_limits (request_id: {})",
            request_id
        );
    ...
    pub async fn update_configuration(
        ...
        self.client
            .update_configuration(request_id, section, updates)
            .await
    }
}
