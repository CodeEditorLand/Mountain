...
// @description This module defines the central, shared, thread-safe state for
// the entire Mountain application. It includes the main `ApplicationState`
// struct, all of its related Data Transfer Objects (DTOs), and internal helper
// functions.
//
