// File: Rpc/Args/Terminal/CreateTerminalArgument.rs

use std::collections::HashMap;

use serde::Deserialize;
use serde_json::Value; // For fields like Args, Cwd, IconPath, Location which can be complex
...
pub struct CreateTerminalArgument {
	...
	#[serde(alias = "args", alias = "shellArgs")] // Common aliases
	pub ShellArguments: Option<Value>,
