pub fn Matches(MethodName:&str) -> bool {
	match MethodName {
		register_hover_provider, register_completion_item_provider, register_definition_provider, register_reference_provider, register_code_actions_provider, register_document_highlight_provider, register_document_symbol_provider, register_workspace_symbol_provider, register_rename_provider, register_document_formatting_provider, register_document_range_formatting_provider, register_on_type_formatting_provider, register_signature_help_provider, register_code_lens_provider, register_folding_range_provider, register_selection_range_provider, register_semantic_tokens_provider, register_inlay_hints_provider, register_type_hierarchy_provider, register_call_hierarchy_provider, register_linked_editing_range_provider, register_document_link_provider, register_color_provider, register_implementation_provider, register_type_definition_provider, register_declaration_provider, register_evaluatable_expression_provider, register_inline_values_provider, register_inline_completion_item_provider, register_inline_edit_provider, register_multi_document_highlight_provider, register_mapped_edits_provider, register_document_paste_edit_provider, register_document_drop_edit_provider => true,
		_ => false,
	}
}
