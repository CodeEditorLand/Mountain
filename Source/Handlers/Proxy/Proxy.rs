...
// Defines a deprecated generic proxy handler for passthrough calls to the sidecar.
// This approach is being replaced by specific, type-safe RPC methods and effects.
...
/// Handles generic proxy calls from the frontend intended for the Cocoon extension host.
/// This function is deprecated and should not be used in new implementations.
/// It logs a warning and returns an error indicating its deprecated status.
