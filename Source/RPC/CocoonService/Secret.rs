...
use crate::{
	Vine::Generated::{DeleteSecretRequest, Empty, GetSecretRequest, GetSecretResponse, StoreSecretRequest},
	dev_log,
};
...
pub async fn StoreSecret(Service:&CocoonServiceImpl, req:StoreSecretRequest) -> Result<Response<Empty>, Status> {
...
pub async fn DeleteSecret(Service:&CocoonServiceImpl, req:DeleteSecretRequest) -> Result<Response<Empty>, Status> {
