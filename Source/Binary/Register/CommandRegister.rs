...
use crate::{ApplicationState::Struct::ApplicationState::ApplicationState, Command};
...
/// # Registered Commands
///
/// This function delegates to `Command::Bootstrap::Fn`
...
pub fn Fn(
	...
	Command::Bootstrap::Fn(ApplicationHandle, AppState)
