...
use crate::{
	IPC::WindAdvancedSync::InitializeWindAdvancedSync,
...
pub fn Fn(ApplicationHandle:&tauri::AppHandle, RunTime:Arc<ApplicationRunTime>) -> Result<(), String> {
	match InitializeWindAdvancedSync(ApplicationHandle, RunTime) {
		Ok(()) => {
