...
use crate::{
	...
	Binary::Build::DnsCommands::{
		DnsGetForwardAllowlist::Fn,
		DnsGetHealthStatus::Fn,
		DnsGetServerInfo::Fn,
		DnsGetZoneInfo::Fn,
		DnsHealthCheck::Fn,
		DnsResolve::Fn,
		DnsTestResolution::Fn,
		StartupTime::Fn,
	},
	// Binary submodule imports
	Binary::Build::Fn::Fn as LocalhostPluginFn,
	Binary::Build::Fn::Fn as LoggingPluginFn,
	Binary::Build::Scheme::{self, DnsPort, LandSchemeHandler, RegisterLandService, init_service_registry},
	Binary::Build::ServiceRegistry::Struct as ServiceRegistryFn,
	Binary::Build::Fn::Fn as TauriBuildFn,
	...
	Binary::Fn::CliParse::Parse as CliParseFn,
	Binary::Fn::LogLevel::Resolve as ResolveLogLevel,
	Binary::Fn::PortSelector::BuildUrl as BuildPortUrl,
	Binary::Fn::PortSelector::Select as SelectPort,
	Binary::Fn::StateBuild::Build as BuildStateFn,
	...
	Binary::Shutdown::Fn::Fn as RuntimeShutdownFn,
	Binary::Shutdown::Fn::Fn as SchedulerShutdownFn,
	Command,
...
pub fn Fn() {
	...
	Runtime.block_on(async {
		...
		// Must run BEFORE PostHogPlugin::Fn so the client
		...
		// ---------------------------------------------------------------------
		crate::Binary::Build::PostHogPlugin::Fn::Fn().await;
		...
		// ---------------------------------------------------------------------
		CommonLibrary::Telemetry::Fn::Fn(CommonLibrary::Telemetry::Tier::Tier::Mountain).await;
		...
		// -------------------------------------------------------------------
		{
			let InitialFolderPaths = crate::Binary::Fn::CliParse::ParseWorkspaceFolders();
			if InitialFolderPaths.is_empty() {
				...
				use crate::ApplicationState::DTO::WorkspaceFolderStateDTO::Struct;
		...
		Builder
			...
			.setup({
				...
				move |app:&mut App| {
					...
					RegisterLandService("code.land.playform.cloud", ServerPortForClosure);

					// Register API editor service (same port for now, can be separate later)
					RegisterLandService("api.land.playform.cloud", ServerPortForClosure);

					// Register assets editor service (same port for now, can be separate later)
					RegisterLandService("assets.land.playform.cloud", ServerPortForClosure);
					...
					if dns_port == 0 {
						...
						crate::Binary::Build::DnsCommands::StartupTime::Fn();
					}
			...
			.register_asynchronous_uri_scheme_protocol("fiddee", |_ctx, request, responder| {
				...
				let Response = crate::Binary::Build::Scheme::LandSchemeHandler(&request);
			...
			.invoke_handler(tauri::generate_handler![
				crate::Binary::Tray::Fn::Fn,

				crate::Binary::IPC::WorkbenchConfigurationCommand::Fn,

				Command::TreeView::Fn::Fn,

				Command::LanguageFeature::Fn::Fn,
				...
				Command::SourceControlManagement::Fn::Fn,

				Command::Keybinding::Fn::Fn,

				Track::FrontendCommand::Fn::Fn,

				Track::UIRequest::Fn::Fn,

				Track::Webview::Fn::Fn,

				crate::Binary::IPC::MessageReceiveCommand::Fn,

				crate::Binary::IPC::StatusGetCommand::Fn,

				crate::Binary::IPC::InvokeCommand::Fn,

				crate::Binary::IPC::WindConfigurationCommand::Fn,

				crate::Binary::IPC::ConfigurationUpdateCommand::Fn,

				crate::Binary::IPC::ConfigurationSyncCommand::Fn,

				crate::Binary::IPC::ConfigurationStatusCommand::Fn,

				crate::Binary::IPC::IPCStatusCommand::Fn,

				crate::Binary::IPC::IPCStatusHistoryCommand::Fn,

				crate::Binary::IPC::IPCStatusReportingStartCommand::Fn,

				crate::Binary::IPC::PerformanceStatsCommand::Fn,

				crate::Binary::IPC::CacheStatsCommand::Fn,

				crate::Binary::IPC::CollaborationSessionCommand::Fn,
				...
				crate::Binary::IPC::UpdateSubscriptionCommand::Fn,
				...
				crate::Binary::Build::DnsCommands::Fn::Fn,
				...
				crate::Binary::IPC::ProcessCommand::Fn::Fn,
				...
				crate::Binary::IPC::HealthCommand::Fn::Fn,
				...
				crate::Binary::IPC::RenderDevLogCommand::Fn,

				// LAND-PATCH B7-S6 P14.5: Vine notification broadcast
				// subscription. `VineSubscribeNotifications` opens a
				...
				// `Stream<NotificationFrame>`. `VineSubscriberCount`
				// is a diagnostic for verifying registrations didn't
				// leak across reloads.
				crate::Binary::IPC::VineSubscribeCommand::VineSubscribeNotifications,

				crate::Binary::IPC::VineSubscribeCommand::VineSubscriberCount,
			])
