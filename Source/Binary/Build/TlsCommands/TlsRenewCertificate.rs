//! `TlsRenewCertificate` Tauri command - regenerates the
...
#[tauri::command]
pub async fn Fn(app_handle:AppHandle, hostname:String) -> Result<String, String> {
...

	{
		...
		let _result = manager.RenewCertificate(&hostname);
	}
