//! `DnsResolve` Tauri command - manual resolution helper used
//! by the diagnostic panel and by `DnsTestResolution`.
//!
...
#[tauri::command]
pub fn Fn(domain:String, dns_port:State<DnsPort>) -> Result<DnsResolutionResult, String> {
	if dns_port.0 == 0 {
