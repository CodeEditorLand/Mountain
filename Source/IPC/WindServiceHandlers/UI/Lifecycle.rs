...
pub async fn LifecycleWhenPhase(runtime:Arc<ApplicationRunTime>, args:Vec<Value>) -> Result<Value, String> {
...
pub async fn LifecycleRequestShutdown(app_handle:AppHandle) -> Result<Value, String> {
	app_handle.exit(0);
	Ok(Value::Null)
}
