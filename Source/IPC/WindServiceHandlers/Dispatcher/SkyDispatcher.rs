...
use crate::Sky::ReplayEvents::Fn as SkyReplayEvents;
...
pub async fn dispatch_sky(
    ...
    match command {
        ...
        "sky:editor:visibleChanged" | "sky:editor:tabsChanged" |
        "sky:editor:visibleRangesChanged" | "sky:editor:optionsChanged" |
        "sky:editor:diffInformationChanged" | "sky:editor:viewColumnChanged" => {
