...
use crate::Extension::{ExtensionInstall::Fn as ExtensionInstall, ExtensionUninstall::Fn as ExtensionUninstall, VsixPathFromArgs::Fn as VsixPathFromArgs};
    ...
    match command {
        ...
        "extensions:getManifest" => {
            let vsix_path = match arguments.first() {
                ...
                Some(obj) => obj.get("fsPath").and_then(|v| v.as_str()).map(str::to_owned)
