...
pub async fn dispatch_terminal(
    ...
    match command {
        ...
        "localPty:getTerminalLayoutInfo" => {
            // Storage query
            let provider: std::sync::Arc<dyn crate::CommonLibrary::Storage::StorageProvider::StorageProvider> = runtime.Environment.Require();
        ...
        "localPty:setTerminalLayoutInfo" => {
            ...
            let _ = provider.UpdateStorageValue(true, "terminal:layoutInfo".to_string(), Some(payload)).await;
