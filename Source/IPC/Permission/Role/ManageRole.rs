...
impl Role {
    ...
    pub fn New(
        ...
        let UniquePermissions: Vec<String> = Permissions
            .into_iter()
    ...
    pub fn AddPermission(mut self, Permission: String) -> Self {
        if !self.Permissions.contains(&Permission) {
            ...
            debug!("[Role] Permission '{}' already exists in role '{}', skipping", Permission, self.Name);
        }
        self
    }
    ...
    ///
    pub fn PermissionCount(&self) -> usize {
    ...
    pub fn Validate(&self) -> Result<(), String> {
        ...
        for Permission in &self.Permissions {
            ...
            if Permission.contains(|c: char| c.is_whitespace()) {
                return Err(format!(
                    "Permission '{}' cannot contain whitespace",
                    Permission
                ));
            }
        }
...
mod Tests {
    ...
    fn TestPermissionNewSensitive() {
        let perm = Permission::NewSensitive(
            "config.update".to_string(),
