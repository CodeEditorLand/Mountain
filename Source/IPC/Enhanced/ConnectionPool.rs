...
//! 
//! Advanced connection pooling for concurrent IPC operations with health monitoring
...
use tokio::sync::{Mutex as AsyncMutex, RwLock, Semaphore, Notify};
...
impl ConnectionHandle {
    ...
    pub fn is_healthy(&self) -> bool {
        ...
        self.error_count < 5 && 
        self.is_active &&
        self.age().as_secs() < 300 // Less than 5 minutes old
    }
...
impl ConnectionPool {
    ...
    pub async fn get_connection(&self) -> Result<ConnectionHandle, String> {
        ...
        // Update wait time statistics
        {
            ...
            stats.average_wait_time_ms = 
                (stats.average_wait_time_ms * stats.total_operations as f64 + wait_time) 
    ...
    pub async fn get_healthy_count(&self) -> usize {
        self.stats.read().await.healthy_connections
    }
...
mod tests {
    ...
    async fn test_pool_statistics() {
        ...
        let handles: Vec<ConnectionHandle> = (0..3)
            .map(|_| pool.get_connection().await.unwrap())
            .collect();
