...
//! Supports Brotli compression for large payloads and intelligent message batching.

#![allow(non_snake_case, non_camel_case_types)]

use std::{collections::VecDeque, time::Duration};
use brotli::{CompressorReader, CompressorWriter, BrotliEncoderParams};
...
impl MessageCompressor {
    ...
    pub fn flush_batch(&mut self) -> Result<CompressedBatch, String> {
        ...
        // Serialize batch
        let serialized_batch = bincode::serialize(&batch_messages)
    ...
    pub fn get_batch_stats(&self) -> BatchStats {
        BatchStats {
            ...
            batch_age_ms: self.batch_start_time
