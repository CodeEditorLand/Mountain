...
//!
//! ## RESPONSIBILITIES
//! This module provides the main IPC server orchestrator for Mountain, establishing
//! and managing the bidirectional communication bridge between Mountain's Rust backend
//! and Wind's TypeScript frontend.
//!
//! ## ARCHITECTURAL ROLE
//! This module is the core of the IPC layer, orchestrating all IPC operations and
//! coordinating between submodules.
//!
//! ## KEY COMPONENTS
//!
...
//!
//! ## LOGGING
//! Info-level logging for lifecycle events, debug for operations, error for failures.
//!
