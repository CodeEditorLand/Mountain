...
//!
//! The single `impl DocumentProvider for MountainEnvironment` block in this file
//! delegates to those helper functions. This satisfies Rust's orphan rules while
//! keeping code organized and atomic.
...
impl DocumentProvider for crate::Environment::MountainEnvironment::MountainEnvironment {
	...
	async fn SaveAllDocuments(&self, IncludeUntitled: bool) -> Result<Vec<bool>, CommonLibrary::Error::CommonError::CommonError> {
