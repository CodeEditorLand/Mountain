...
//!
//! Provides language feature intelligence through extension-hosted LSP providers.
//! Manages provider registration, lookup, and invocation for hover, completion,
...
//!
//! The single `impl LanguageFeatureProviderRegistry for MountainEnvironment` block
//! in this file delegates to those helper functions. This satisfies Rust's orphan
//! rules while keeping code organized and atomic.

use CommonLibrary::LanguageFeature::LanguageFeatureProviderRegistry::LanguageFeatureProviderRegistry;
use CommonLibrary::LanguageFeature::DTO::{
