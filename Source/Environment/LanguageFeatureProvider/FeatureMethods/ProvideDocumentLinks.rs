//! Provides document links by invoking the matching `DocumentLink` provider
//! in its owning sidecar.
...
pub(crate) async fn Fn(
	...
	let provider =
		super::super::ProviderLookup::get_matching_provider(environment, &document_uri, ProviderType::DocumentLink)
			.await?;
