...
// to be rendered.
pub async fn SetEntryLogic<R:RunTime>(ApplicationHandle:&ApplicationHandle<R>, Entry:StatusBarEntryDto) -> Result<(), CommonError> {
...
pub async fn DisposeEntryLogic<R:RunTime>(ApplicationHandle:&ApplicationHandle<R>, EntryId:String) -> Result<(), CommonError> {
