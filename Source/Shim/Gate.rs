...
pub fn is_proxy() -> bool { TIER_SHIM == "Proxy" }

/// 🔵 Service replacement active (Replace or deeper).
pub fn is_replace_or_deeper() -> bool { matches!(TIER_SHIM, "Replace" | "Own" | "Preempt") }

/// 🟠 Full container ownership active (Own or Preempt).
pub fn is_own_or_preempt() -> bool { matches!(TIER_SHIM, "Own" | "Preempt") }

/// 🟠 Nuclear option: Land controls BrowserMain.open().
pub fn is_preempt() -> bool { TIER_SHIM == "Preempt" }

/// The current shim level as a string.
pub fn current_level() -> &'static str { TIER_SHIM }
