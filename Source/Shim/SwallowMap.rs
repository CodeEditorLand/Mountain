...
static RULES:&[Rule] = &[
	...
	Rule {
		...
		action:SwallowAction::Swallow,

		target:RedirectTarget::Wind,
	},
	// ── 🔵 SCM ──
	...
	Rule {
		...
		target:RedirectTarget::Mountain,
	},
	// ── 🔵 Terminal ──
	Rule {
		pattern:"terminal:",
...
pub fn should_passthrough(method:&str) -> bool { matches!(decide(method).0, SwallowAction::Passthrough) }
