...
// @description Defines the Data Transfer Objects for representing text changes
// in a document, compatible with VS Code's RPC protocol.
...
// replaced and the new text to insert.
#[derive(Deserialize, Debug, Clone)]
#[serde(rename_all = "PascalCase")]
