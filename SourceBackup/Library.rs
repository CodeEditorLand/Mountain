...
// Mountain application, declaring all of its major internal components. This
// allows the `Binary.rs` file to have a clean entry point.
...
/// The main entry point for mobile builds, which is required by Tauri
/// but delegates to the primary binary logic.
#[allow(dead_code)]
